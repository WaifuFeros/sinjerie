...
[CreateAssetMenu(menuName = "Enemy/Behavior/Vénère Heal")]
public class VenereHeal : EnemyBehaviorSO
{
    public override ObjetSO[] ChooseItem(ObjetSO[] objs, int MaxHealth, int health, int stamina)
    {
        ...
        foreach (var obj in objs)
        {
            ...
            if (staminaAvailable - selecObj.objetWeight >= 0 && selecObj.objectType == ObjetEffectType.Heal)
            {
